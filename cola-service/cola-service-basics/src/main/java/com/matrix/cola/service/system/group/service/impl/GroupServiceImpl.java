package com.matrix.cola.service.system.group.service.impl;
...
import com.matrix.cola.api.entity.system.group.GroupTree;
...
import com.matrix.cola.service.system.group.mapper.GroupMapper;
...
public class GroupServiceImpl extends AbstractEntityService<GroupEntity, GroupMapper> implements GroupService {
    ...
    public Result getGroupTreeByCurrentUser() {
        UserEntity userPO = DubboUtil.getUser();
