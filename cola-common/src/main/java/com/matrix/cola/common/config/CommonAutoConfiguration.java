...
import com.matrix.cola.common.initializer.DubboApplicationInitializer;
...
public class CommonAutoConfiguration {
    ...
    @Bean
    public DubboApplicationInitializer getDubboApplicationInitializer() {
        return new DubboApplicationInitializer();
    }
